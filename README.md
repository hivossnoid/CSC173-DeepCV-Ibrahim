...
- Framework: PyTorch (for the sequence model) and Python/OpenCV (for real-time pipeline/keypoint extraction).Hardware: Google Colab Pro (for GPU training with $\approx 100$ epochs) and Local PC/NVIDIA Jetson Nano (for real-time inference testing).
